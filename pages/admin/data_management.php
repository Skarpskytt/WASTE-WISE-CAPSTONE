...
$inv_total = $pdo->query("SELECT COUNT(*) FROM data_management")->fetchColumn();
$inv_total_pages = ceil($inv_total / $inv_per_page);
$inv_offset = ($inv_page - 1) * $inv_per_page;

// Fetch Inventory Data with LIMIT/OFFSET
$invStmt = $pdo->prepare("SELECT * FROM data_management ORDER BY id DESC LIMIT :limit OFFSET :offset");
