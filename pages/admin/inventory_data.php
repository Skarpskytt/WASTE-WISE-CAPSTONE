...
<div class="p-7">
  ...
  <div>
    ...
    <p class="text-gray-500 mt-2">Add new Data</p>
  </div>
        ...
        <form class="w-full bg-white shadow-xl p-6 border">
          <div class="flex flex-wrap -mx-3 mb-6">
            <div class="w-full md:w-full px-3 mb-6">
                <label class="block uppercase tracking-wide text-gray-700 text-sm font-bold mb-2" htmlFor="category_name">Inventory Name</label>
            ...
            <div class="flex flex-1">
              <div class="w-full md:w-full px-3 mb-6">
                <label class="block uppercase tracking-wide text-gray-700 text-sm font-bold mb-2" htmlFor="category_name">Inventory Price</label>
            ...
            <div class="w-full md:w-full px-3 mb-6">
              <label class="block uppercase tracking-wide text-gray-700 text-sm font-bold mb-2" htmlFor="category_name">Inventory Type</label>
            ...
            <div class="w-full px-3 mb-6">
                <label class="block uppercase tracking-wide text-gray-700 text-sm font-bold mb-2" htmlFor="category_name">Inventory Description</label>
            ...
            <div class="w-full md:w-full px-3 mb-6">
                ...
                hover:bg-green-600 focus:outline-none focus:bg-white focus:border-gray-500" id="productimage">Add Inventory</button>
            </div>
            ...
            <div class="w-full px-3 mb-8">
                ...
                <h2 class="mt-4 text-xl font-medium text-gray-700 tracking-wide">Inventory Image</h2>
