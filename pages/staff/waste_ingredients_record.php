<?php
// Fix the file paths - remove one level of "../"
...
// Change table name from inventory to data_management
$sql    = "SELECT * FROM data_management WHERE 1=1";
$params = [];
...
<div class="p-6 w-full">
  <h2 class="text-2xl font-semibold mb-6">Waste History Data</h2>
          ...
          <tbody>
            <?php
              if (!empty($inventory)) {
                ...
                echo "<tr><td colspan='10' class='text-center'>No Waste items found.</td></tr>";
              }
            ?>
          </tbody>
        </table>
